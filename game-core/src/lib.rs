...
impl WorldMap {
    pub fn new(width: usize, height: usize) -> Self {
        ...
        fn is_area_free(grid: &Vec<Vec<Option<LocationType>>>, x: usize, y: usize, w: usize, h: usize) -> bool {
      ...
      fn fill_area(grid: &mut Vec<Vec<Option<LocationType>>>, x: usize, y: usize, w: usize, h: usize, loc_type: LocationType) {
          for dy in 0..h {
              for dx in 0..w {
      ...
      for _ in 0..3 {  // Try to place 3 parks
